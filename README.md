...
- DB-driven cleanup cannot discover the rare unknown object left by a process crash after S3 upload but before attachment metadata persistence; future bucket-inventory reconciliation remains explicit follow-up work.
